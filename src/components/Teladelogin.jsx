...
export default () => {
    return(
        ...
        <Text style={{marginTop: 50,fontSize: 25, marginLeft: 10, color:'#000000' }}>Bem-vindo de volta!</Text>
        <Text style={{marginLeft: 10, marginBottom: 70}}>Entre para continuar</Text>
    ...
    <Pressable style={{justifyContent: 'center', alignItems: 'center', marginTop: 50,}} onPress={''}>
              <Text style={{backgroundColor: '#000272', borderRadius: 7, width: 300,padding:13,color: 'white', textAlign: 'center'}}>Entrar</Text>
            </Pressable>
